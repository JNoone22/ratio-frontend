...
function App() {
  ...
  const filteredAssets = assets.filter(asset => {
    ...
    const commoditySymbols = ['GLD', 'SLV', 'USO', 'UNG', 'CORN', 'WEAT', 'SOYB', 'GDX']
    const isCommodity = commoditySymbols.includes(asset.symbol)
    
    // S&P 500 detection (backend will eventually send this as asset.sp500 flag)
    const isSP500 = asset.sp500 || (asset.type === 'stock' && asset.rank <= 500) // Rough proxy for now
  ...
  const cmdtySymbols = ['GLD', 'SLV', 'USO', 'UNG', 'CORN', 'WEAT', 'SOYB']
  ...
  const getGridSymbols = () => {
    ...
    if (gridType === 'cmdty') return cmdtySymbols
        ...
        <div className="install-banner">
          <div className="install-content">
            ...
            <div className="install-text">
              <strong>Install Front Runner</strong>
              {isIOS ? (
          ...
          <>
            <div className="controls">
              ...
              <div className="filter-tabs">
                {['all', 'sp500', 'etfs', 'cmdty', 'crypto'].map(tab => (
                  <button
                    key={tab}
                    className={`filter-tab ${filter === tab ? 'active' : ''}`}
                    onClick={() => setFilter(tab)}
                  >
                    {tab === 'sp500' ? 'S&P 500' : tab === 'cmdty' ? 'CMDTY' : tab.toUpperCase()}
                  </button>
                ))}
              </div>
            </div>
                ...
                >
                  ...
                  <div className="col-type">
                    <span className="type-badge">
                      {['GLD', 'SLV', 'USO', 'UNG', 'CORN', 'WEAT', 'SOYB', 'GDX'].includes(asset.symbol) 
                        ? 'Commodity' 
          ...
          <>
            <div className="controls">
              ...
              <div className="filter-tabs">
                ...
                <button
                  className={`filter-tab ${gridType === 'cmdty' ? 'active' : ''}`}
                  onClick={() => setGridType('cmdty')}
                >
                  CMDTY
                </button>
                <button
