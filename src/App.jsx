    ...
    <div className="app">
              ...
              {gridType === 'custom' && customGridAssets.length < 2 ? (
                ...
                <>
                  ...
                  <div className="grid-explainer">
                    ...
                    <p>
                      Each cell shows the winner of a head-to-head matchup using synthetic pairs. We create a ratio of the column asset divided by the row asset (e.g., NVDA/TSLA), then compare the current ratio to the 20-week moving average of that ratio. A <strong className="win-indicator">green W</strong> means the current ratio is above its own trend—the column asset is outperforming. A <strong className="loss-indicator">red L</strong> means the ratio is below trend—the row asset is winning.
                    </p>
                  </div>
                </>
              )}
      ...
      {activePage === 'how-it-works' && (
        ...
        <div style={{marginBottom: '30px'}}>
          ...
          <p style={{lineHeight: '1.8', color: '#ccc'}}>
            Start with The Big Board to see what's leading the market right now, with 1,700+ assets ranked daily by head-to-head strength. Head over to The Grid to compare market leaders head-to-head, or build a custom grid with the assets you're tracking. Click any asset to dive deeper into its full stats, tournament record, and current position relative to key moving averages.
          </p>
        </div>
      </div>
      )}
