...
function App() {
  ...
  return (
    <div className="app">
      ...
      <div id="how-it-works" style={{padding: '60px 20px', maxWidth: '800px', margin: '0 auto', display: activePage === 'board' ? 'block' : 'none'}}>
        <p style={{fontSize: '24px', marginBottom: '40px', color: '#ccc', textAlign: 'center', lineHeight: '1.5'}}>
          Markets aren't about what's going up — they're about what's winning.
        </p>
        
        <p style={{lineHeight: '1.8', color: '#ccc', marginBottom: '40px'}}>
          FrontRunner is built on a simple idea: markets reward relative strength. We rank every tradable asset head-to-head against each other, making leadership visible so you can focus on what's winning.
        </p>
        ...
        <div style={{marginBottom: '40px'}}>
          ...
          <div style={{marginBottom: '30px'}}>
            ...
            <p style={{lineHeight: '1.8', color: '#ccc'}}>
              Turn complex market data into a simple 7x7 head-to-head matchup table. Pick an asset on the top row, and follow that row down to view how that asset performs in each head-to-head matchup. Green W's means the asset at the top of that column is outperforming the asset to the far left in that specific row. Red L's means the opposite, that the asset at the top of the column is being outperformed by the asset to the far left in that specific row. See exactly how the market's most important assets stack up against each other, or build your own custom Grid to compare your favorites.
            </p>
          </div>
        </div>
        ...
        <div style={{marginBottom: '30px'}}>
          ...
          <p style={{lineHeight: '1.8', color: '#ccc'}}>
            Start with The Big Board to see what's leading the market right now, with 1,700+ assets ranked daily by head-to-head strength. The "Trend Weeks" column shows momentum, and can help identify newly trending assets that have just recently flipped bullish. Use The Grid to compare specific assets head-to-head, or build a custom grid with the assets you're tracking. Click any asset to dive deeper into its full stats, tournament record, and current position relative to key moving averages.
          </p>
        </div>
      </div>
