            ...
            <div className="board-container" key={filter}>
              <div className="board-header">
                ...
                <div className="col-weeks">
                  Trend Weeks
                  <span className="info-icon" data-tooltip="Number of consecutive weeks asset has been above its 20-week moving average">ⓘ</span>
                </div>
                <div className="col-price desktop-only">Price</div>
                <div className="col-ema8 desktop-only">
                  8W EMA
                  <span className="info-icon" data-tooltip="8-week Exponential Moving Average (faster-reacting short-term trend indicator)">ⓘ</span>
                </div>
                <div className="col-ma20 desktop-only">
                  20W SMA
                  <span className="info-icon" data-tooltip="20-week Simple Moving Average (primary trend indicator for bull/bear status)">ⓘ</span>
                </div>
