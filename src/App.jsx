...
function App() {
  ...
  const filteredAssets = assets.filter(asset => {
    ...
    // Type filter (simplified - would need backend support for accurate filtering)
    if (filter === 'all') return true
    // For now, show all - can enhance with asset type metadata from backend
    return true
  })
      ...
      <main className="main">
        ...
        <div className="big-board">
          <div className="board-header">
            ...
            <div className="col-ma">vs MA</div>
            ...
            {filteredAssets.map((asset, index) => (
              ...
              >
                <div className="col-rank">
                  <span className={`rank-badge ${asset.rank <= 3 ? 'top-rank' : ''}`}>
                    #{asset.rank}
                  </span>
                </div>
        ...
        <div className="modal-overlay" onClick={() => setSelectedAsset(null)}>
          <div className="modal-content" onClick={e => e.stopPropagation()}>
            ...
            <div className="modal-stats">
              ...
              <div className="modal-stat">
                <div className="modal-stat-label">vs 20W MA</div>
                <div
