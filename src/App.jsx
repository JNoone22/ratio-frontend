...
function App() {
  ...
  const comsSymbols = ['GLD', 'SLV', 'USO', 'UNG', 'CORN', 'WEAT', 'SOYB']
  ...
  const getGridSymbols = () => {
    ...
    if (gridType === 'coms') return comsSymbols
          ...
          <>
            <div className="controls">
              ...
              <div className="filter-tabs">
                {['all', 'sp500', 'stocks', 'etfs', 'coms', 'crypto'].map(tab => (
                  <button
                    key={tab}
                    className={`filter-tab ${filter === tab ? 'active' : ''}`}
                    onClick={() => setFilter(tab)}
                  >
                    {tab === 'sp500' ? 'S&P 500' : tab === 'coms' ? 'COMS' : tab.toUpperCase()}
                  </button>
                ))}
              </div>
            </div>
          ...
          <>
            <div className="controls">
              ...
              <div className="filter-tabs">
                ...
                <button
                  className={`filter-tab ${gridType === 'coms' ? 'active' : ''}`}
                  onClick={() => setGridType('coms')}
                >
                  COMS
                </button>
                <button
