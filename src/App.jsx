    ...
    <div className="app">
      ...
      {activePage === 'how-it-works' && (
        ...
        <div style={{marginBottom: '30px'}}>
          ...
          <p style={{lineHeight: '1.8', color: '#ccc'}}>
            Start with The Big Board to see what's leading the market right now, with 1,700+ assets ranked daily by head-to-head strength. The "Trend Weeks" column shows momentum, and can help identify newly trending assets that have just recently flipped bullish. Head over to The Grid to compare specific assets head-to-head, or build a custom grid with the assets you're tracking. Click any asset to dive deeper into its full stats, tournament record, and current position relative to key moving averages.
          </p>
        </div>
      </div>
      )}
      ...
      {activePage === 'partners' && (
        <div style={{padding: '60px 20px', maxWidth: '800px', margin: '0 auto'}}>
          <h1 style={{fontSize: '36px', marginBottom: '40px', color: '#00ff9d', textAlign: 'center'}}>Partners</h1>
          <p style={{lineHeight: '1.8', color: '#ccc'}}>
