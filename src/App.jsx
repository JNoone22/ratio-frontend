...
function App() {
  ...
  const [gridType, setGridType] = useState('mag7') // 'mag7', 'indices', 'crypto', 'commodity', 'custom'
  ...
  return (
    <div className="app">
      ...
      <main className="main">
        ...
        {activePage === 'board' && (
          <>
            ...
            <div className="board-container" key={`${filter}-${search}`}>
              ...
              {rankedAssets.map((asset) => (
                ...
                >
                  ...
                  <div className="col-weeks">
                    <span className="weeks-value" style={{
                      color: asset.percent_from_ema8 > 0 ? '#00ff9d' : '#ff4d6a'
                    }}>
                      {asset.percent_from_ema8 > 0 ? '+' : ''}{asset.percent_from_ema8?.toFixed(1) || '0.0'}%
                    </span>
                  </div>
      ...
      {activePage === 'faq' && (
        <div style={{padding: '60px 20px', maxWidth: '800px', margin: '0 auto'}}>
          ...
          <div style={{marginBottom: '40px'}}>
            ...
            <p style={{lineHeight: '1.8', color: '#ccc'}}>
              FrontRunner ranks stocks, ETFs, commodities, and cryptocurrencies by relative strength using a tournament algorithm. Every asset competes head-to-head against every other asset to determine which are truly leading the market.
            </p>
          </div>
          ...
          <div style={{marginBottom: '40px'}}>
            ...
            <p style={{lineHeight: '1.8', color: '#ccc'}}>
              We track the S&P 1500 stocks (all large, mid, and small-cap US stocks), 50+ major ETFs, 100+ cryptocurrencies, 10+ commodities, as well as a handful of stocks not included in the S&P—over 1,700 assets total.
            </p>
          </div>
        ...
        <div style={{padding: '60px 20px', maxWidth: '800px', margin: '0 auto'}}>
          ...
          <div style={{marginBottom: '50px'}}>
            ...
            <div style={{marginBottom: '30px', padding: '20px', background: 'rgba(0, 255, 157, 0.05)', borderRadius: '8px', border: '1px solid rgba(0, 255, 157, 0.2)'}}>
              ...
              <a href="https://coinbase.com/join/ZLV6LXC?src=referral-link" target="_blank" rel="noopener noreferrer" style={{color: '#00ff9d', textDecoration: 'none', fontWeight: '600'}}>
                → Open an account
              </a>
            </div>
            ...
            <div style={{marginBottom: '30px', padding: '20px', background: 'rgba(0, 255, 157, 0.05)', borderRadius: '8px', border: '1px solid rgba(0, 255, 157, 0.2)'}}>
              ...
              <a href="https://invite.kraken.com/JDNW/c55kzjz7" target="_blank" rel="noopener noreferrer" style={{color: '#00ff9d', textDecoration: 'none', fontWeight: '600'}}>
                → Open an account
              </a>
            </div>
          </div>
          ...
          <div style={{marginBottom: '50px'}}>
            ...
            <div style={{marginBottom: '30px', padding: '20px', background: 'rgba(0, 255, 157, 0.05)', borderRadius: '8px', border: '1px solid rgba(0, 255, 157, 0.2)'}}>
              ...
              <a href="https://www.tradingview.com/pricing/?aff_id=163662&aff_sub=frontrunner_launch" target="_blank" rel="noopener noreferrer" style={{color: '#00ff9d', textDecoration: 'none', fontWeight: '600'}}>
                → Explore TradingView
              </a>
            </div>
          </div>
      ...
      {/* Tournament Deep Dive Page (hidden - link-only access) */}
      {activePage === 'tournament-deep-dive' && (
        <div className="page-content" style={{maxWidth: '800px', margin: '0 auto', padding: '40px 20px'}}>
          <h1 style={{fontSize: '36px', marginBottom: '20px', color: '#00ff9d', fontWeight: '700'}}>Tournament Algorithm Deep Dive</h1>
          
          <div style={{marginBottom: '30px'}}>
            <p style={{lineHeight: '1.8', color: '#ccc', marginBottom: '20px'}}>
              The Tournament algorithm is FrontRunner's core ranking system. It answers one simple question: <em>Which assets are demonstrating the strongest momentum right now?</em>
            </p>
          </div>

          <div style={{marginBottom: '30px'}}>
            <h3 style={{fontSize: '20px', marginBottom: '12px', fontWeight: '700', color: '#fff'}}>How It Works: Step by Step</h3>
            
            <p style={{lineHeight: '1.8', color: '#ccc', marginBottom: '16px'}}>
              <strong style={{color: '#fff'}}>Step 1: Create Synthetic Pairs</strong><br />
              For every possible pairing of assets (Asset A vs Asset B), we create a synthetic pair by dividing Asset A's price by Asset B's price. This ratio tells us how Asset A is performing <em>relative</em> to Asset B over time.
            </p>

            <p style={{lineHeight: '1.8', color: '#ccc', marginBottom: '16px'}}>
              <strong style={{color: '#fff'}}>Step 2: Calculate the Ratio's Moving Average</strong><br />
              We then calculate the 20-week simple moving average (SMA) of that ratio. This moving average represents the historical "normal" relationship between the two assets.
            </p>

            <p style={{lineHeight: '1.8', color: '#ccc', marginBottom: '16px'}}>
              <strong style={{color: '#fff'}}>Step 3: Compare Current Ratio to the MA</strong><br />
              If the current ratio is <strong>above</strong> its 20-week MA, Asset A wins the matchup (it's outperforming). If the ratio is <strong>below</strong> its MA, Asset B wins (it's underperforming relative to B).
            </p>

            <p style={{lineHeight: '1.8', color: '#ccc', marginBottom: '16px'}}>
              <strong style={{color: '#fff'}}>Step 4: Repeat for Every Pair</strong><br />
              This process runs for every possible pairing in our database. With 1,700 assets, that's approximately 1.5 million head-to-head matchups processed daily.
            </p>

            <p style={{lineHeight: '1.8', color: '#ccc'}}>
              <strong style={{color: '#fff'}}>Step 5: Rank by Wins</strong><br />
              Assets are ranked by their total number of wins. The asset that wins the most matchups demonstrates the strongest relative momentum and earns the #1 spot. In cases of ties, we use the asset's distance above its own 20-week MA as a tiebreaker.
            </p>
          </div>

          <div style={{marginBottom: '30px'}}>
            <h3 style={{fontSize: '20px', marginBottom: '12px', fontWeight: '700', color: '#fff'}}>Why This Works</h3>
            <p style={{lineHeight: '1.8', color: '#ccc'}}>
              Traditional rankings rely on absolute price movement ("Stock X is up 5% this week"). FrontRunner measures <em>relative</em> strength. An asset can be rising in absolute terms but falling in relative terms if other assets are rising faster. The tournament algorithm captures this nuance by comparing every asset to every other asset, ensuring the #1 ranked asset is truly outperforming the entire market—not just moving up in isolation.
            </p>
          </div>

          <div style={{marginBottom: '30px'}}>
            <h3 style={{fontSize: '20px', marginBottom: '12px', fontWeight: '700', color: '#fff'}}>What the Rankings Tell You</h3>
            <p style={{lineHeight: '1.8', color: '#ccc'}}>
              A high-ranked asset has won the majority of its head-to-head matchups, meaning it's outperforming most other assets in the market right now. A low-ranked asset is underperforming relative to the field. These rankings update daily as new weekly price data becomes available, reflecting current market leadership without prediction or opinion.
            </p>
          </div>
        ...
        <div className="modal-overlay" onClick={() => setSelectedAsset(null)}>
          <div className="modal-content" onClick={e => e.stopPropagation()}>
            ...
            <div className="modal-stats">
              ...
              {selectedAsset.near_ema8 && (
                <div className="modal-stat" style={{background: 'rgba(255, 159, 10, 0.1)', border: '1px solid rgba(255, 159, 10, 0.3)', borderRadius: '4px', padding: '8px'}}>
                  <div className="modal-stat-label" style={{color: '#ff9f0a'}}>⚠️ Near EMA8</div>
                  <div className="modal-stat-value" style={{fontSize: '14px', color: '#ccc'}}>Within 2%</div>
                </div>
              )}
              <div className="modal-stat">
