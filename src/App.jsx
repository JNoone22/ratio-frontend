...
function App() {
  ...
  useEffect(() => {
    if (filter !== 'all' || !rankedAssets || rankedAssets.length === 0) return // Only for ALL tab with data
  ...
  }, [filter, visibleRows, rankedAssets])
        ...
        {activePage === 'board' && (
          <>
            ...
            <div className="board-container" key={filter}>
              ...
              {filter === 'all' && rankedAssets && visibleRows < rankedAssets.length && (
                <div style={{
                  padding: '30px',
                  textAlign: 'center',
                  color: 'var(--text-dim)',
