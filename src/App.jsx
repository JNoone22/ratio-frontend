...
function App() {
  ...
  const filteredAssets = assets.filter(asset => {
    ...
    const matchesSearch = symbolLower === searchLower || symbolLower.startsWith(searchLower)
  ...
  let rankedAssets = filter === 'all' 
    ? filteredAssets.map(asset => ({ ...asset, displayRank: asset.rank }))
  ...
  if (sortBy === 'trend') {
    ...
    rankedAssets = [...rankedAssets].sort((a, b) => a.rank - b.rank)
  }
